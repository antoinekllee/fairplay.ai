                    ...
                    <div className="space-y-4">
                        <div>
                            <div className="mb-1 flex items-center justify-between text-xs">
                                ...
                                <span className="font-medium">
                                    {data.summary.promotionQuestions}
                                </span>
                            </div>
                            <Progress
                                value={data.summary.promotionQuestions * 12.5}
                        ...
                        <div>
                            <div className="mb-1 flex items-center justify-between text-xs">
                                ...
                                <span className="font-medium">
                                    {data.summary.preventionQuestions}
                                </span>
                            </div>
                            <Progress
                                value={data.summary.preventionQuestions * 12.5}
                                className="h-2 bg-gray-100"
                            />
                        </div>
                ...
                <CardContent>
                    <div className="space-y-4">
                        <div>
                            ...
                            <Progress
                                value={
                                    participants.founder.sentimentScore * 100
                                }
                                className="h-2 bg-gray-100"
                            />
                        </div>
                        <div>
                            ...
                            <Progress
                                value={participants.vc.sentimentScore * 100}
                                className="h-2 bg-gray-100"
                            />
                        </div>
